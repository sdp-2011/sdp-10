...
import plan.path.pathfinding.heuristics.ClosestHeuristic;
import plan.path.pathfinding.heuristics.ManhattanHeuristic;
import plan.path.pathfinding.heuristics.DiagonalHeuristic;
/**
...
public class AStar implements PathFinder{
	...
	/** The set of tiles that we do not yet consider fully searched */
	private SortedList open = new SortedList();
	
	/** The map being searched */
	private WorldMap map;
	/** The maximum depth of search A* goes before quitting */
	private int maxSearchDistance;
	
	/** The complete set of nodes across the map */
	private Node[][] nodes;								 // added a lot of speed to the path planning.
	/** True if we allow diaganol movement */
	private boolean allowDiagMovement;
	/** The heuristic we're applying to determine which tiles to search first */
	private Heuristics heuristic;
	
	/**
	 * Create a path finder with the default heuristic
	 * 
	 * @param map The tile map to be searched
	 * @param maxSearchDistance The maximum depth we'll search before giving up
	 * @param allowDiagMovement True if the search should try diaganol movement
	 */
	public AStar(WorldMap map, int maxSearchDistance, boolean allowDiagMovement) {
	 ...
	 * @param allowDiagMovement True if the search should try diaganol movement
	 */
	public AStar(WorldMap map, int maxSearchDistance, boolean allowDiagMovement, Heuristics heuristic) {
	...
	public Path findPath(Robot robot, int sx, int sy, int tx, int ty) {
		// return null if the destination is blocked
		...
		// we iterate while we've not reached the destination or exhausted the depth
		int maxDepth = 0;
			...
			for (int x=-1;x<2;x++) {
				for (int y=-1;y<2;y++) {
					...
					if (isValidLocation(robot,sx,sy,xp,yp)) {
						// the cost to get to this node is the current plus the movement

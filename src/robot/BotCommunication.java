...
//	Defend defense;
	 ...
	 */
	public BotCommunication(int a, int b){
		this.pilot = new TachoPilot(a, b, Motor.A, Motor.C,true);
	...
	public static void main(String [] args)  throws Exception {
		...
		BotCommunication bot = new BotCommunication(6, 15);

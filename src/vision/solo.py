...
def output(ballpos,blue_from,blue_to,yellow_from,yellow_to,stewies_goal,loiss_goal):
 	if (us == "yellow"):
 		print '\r',ballpos,yellow_from,yellow_to,blue_from,blue_to,stewies_goal,loiss_goal,
		sys.stdout.flush()
# 		s.send(ballpos[0],ballpos[1],yellow_from[0],yellow_from[1],yellow_to[0],yellow_to[1],blue_from[0],blue_from[1],blue_to[0],blue_to[1],stewies_goal[0],stewies_goal[1],loiss_goal[0],loiss_goal[1])
 	elif(us == "blue"):
 		print '\r',ballpos,blue_from,yellow_from,stewies_goal,loiss_goal,
#		s.send(ballpos[0],ballpos[1],blue_from[0],blue_from[1],blue_to[0],blue_to[1],yellow_from[0],yellow_from[1],yellow_to[0],yellow_to[1],stewies_goal[0],stewies_goal[1],loiss_goal[0],loiss_goal[1])
